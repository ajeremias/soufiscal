...
class PublicPlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create public_place" do
    assert_difference('PublicPlace.count') do
      post public_places_url, params: { public_place: { neighborhood_id: @public_place.neighborhood_id, nome: @public_place.nome } }
    end
  ...
  test "should update public_place" do
    patch public_place_url(@public_place), params: { public_place: { neighborhood_id: @public_place.neighborhood_id, nome: @public_place.nome } }
